...
class _UploadPageState extends State<UploadPage> {
  ...
  createPostInFirestore({required String mediaUrl, required String postTitle, required String postDescription}){
    ds.postsRef.doc(postId).set({
      "postId": postId,
      "farmerId": getUidFromPrefs(),
      "mediaUrl": mediaUrl,
      "postTitle": postTitle,
